tableextension 50004 "WDC Item Journal Line TabExt" extends "Item Journal Line"
{
    fields
    {
        ...
        field(50009; "Balance Registration Direction"; Option)
        {
            CaptionML = ENU = 'Balance Registration Direction', FRA = 'Sens enregistrement solde';
            DataClassification = ToBeClassified;
            OptionMembers = ,Inbound,Outbound;
            OptionCaptionML = ENU = ' ,Inbound,Outbound', FRA = ' ,Entrant,Sortant';
        }
        modify("Source No.")
        {
