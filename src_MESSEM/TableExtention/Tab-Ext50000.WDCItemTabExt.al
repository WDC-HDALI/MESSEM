tableextension 50000 "WDC ItemTabExt" extends Item
{
    fields
    {
        ...
        field(50002; "Label Type"; Option)
        {
            CaptionML = ENU = 'Label Type', FRA = 'Type d''étiquette';
            OptionMembers = Standard,FDA,EU,Special,"Standard + Special";
            OptionCaptionML = ENU = 'Standard,FDA,EU,Special,Standard + Special', FRA = 'Standard,Standard Bio FDA,Standard bio EUR,Spécial,Standard + Spécial';
