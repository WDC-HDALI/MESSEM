report 50029 "WDC Production Order Stat BI"
{
    //*****************************Documentation********************************
    ...
    //*****************************************************************************
    DefaultLayout = RDLC;
    RDLCLayout = './.vscode/src_Messem/Report/RDLC/ProductionOrderStatBI.rdlc';

    CaptionML = ENU = 'Production Order Statistic BI', FRA = 'Statistique par O.F BI';
    ApplicationArea = All;
    ...
    dataset
    {
        dataitem("Production Order"; "Production Order")
        {
            ...
            column(SommeCoutMP; SommeCoutMP)
            {
            }
            column(SommeCoutPF; SommeCoutPF)
            {
            }
            column(SommeCoutpackaging; SommeCoutpackaging)
            {
            }
            column(SommeCoutSO; SommeCoutSO)
            {
            }
            column(SommeCoutCR; SommeCoutCR)
            {
            }
            ...
            begin
                ...
                IF ProdOrderLine.FINDSET() THEN begin
                    ...
                    SommeCoutReel := SommeCoutMP + SommeCoutPF + SommeCoutpackaging + SommeCoutSO + SommeCoutCR + CoutCentreReceptionRéel + CoutCentreEqueutageRéel + CoutCentreSurgelationRéel + CoutCentreExpéditionRéel + CoutCentreNettoyageRéel;
