codeunit 50501 "WDC-QA Lot Inspection"
{
    ...
    begin
        ...
        TmpRegisteredInspectionChange."Source Type" := Enum::"WDC-QA Source Type".FromInteger(SourceType);
        TmpRegisteredInspectionChange."Source Subtype" := Enum::"WDC Lot Attribute Src Subtype".FromInteger(SourceSubType);
        ...
        IF ShowForm THEN
            ReturnAction := PAGE.RUNMODAL(PAGE::"WDC-QA Change Lot No. Info", TmpRegisteredInspectionChange);
